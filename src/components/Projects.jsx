...
function Projects() {
  ...
  return (
    <div className='bg-gradient-to-b from-[#e6ecfd] to-[#F5E9FF] pb-10 '>
     ...
     <div >
     <SingleProject projectVideo={GitVideo} projectName="GitInsightX" projectDescription={gitInsightXDescrip} projectTags={gitInsightTags}projectLink="https://git-insight-x-6fke.vercel.app/" />
     <SingleProject projectVideo={TimeEaseVideo} projectName="TimeEase" projectDescription={TimeEaseDescrip} projectTags={ TimeEaseTags} projectLink="https://time-ease.vercel.app/"/>
     <SingleProject projectVideo={QuizManiaVideo} projectName="QuizMania" projectDescription={QuizManiaDescrip} projectTags={ QuizManiaTags} projectLink="https://quiz-mania-three.vercel.app/"/>
     </div>
